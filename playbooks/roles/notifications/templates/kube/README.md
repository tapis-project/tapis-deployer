...
```
    ...
    notifications-pgadmin        ClusterIP    10.102.160.197   <none>        80:30031/TCP
```
...
service/notifications-api-debug        ClusterIP    10.96.180.48     <none>        8000:32066/TCP      42s
```
