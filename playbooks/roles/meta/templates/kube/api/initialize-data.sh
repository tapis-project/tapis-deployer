...
curl -s -X PUT http://restheart-debug:8080/$DB
...
curl -s -X POST -H "$token" -H "$user" -H "$tenant" -H "$content" -d "$data" {{meta_service_url}}/v3/security/user/grantUserPermission?tenant=admin
...
curl -s -X PUT -H "$token" -H "$user" -H "$tenant" -H "$content" {{meta_service_url}}/v3/meta/$DB/streams_instrument_index
curl -s -X PUT -H "$token" -H "$user" -H "$tenant" -H "$content" {{meta_service_url}}/v3/meta/$DB/streams_project_metadata
curl -s -X PUT -H "$token" -H "$user" -H "$tenant" -H "$content" {{meta_service_url}}/v3/meta/$DB/streams_alerts_metadata
curl -s -X PUT -H "$token" -H "$user" -H "$tenant" -H "$content" {{meta_service_url}}/v3/meta/$DB/streams_templates_metadata
curl -s -X PUT -H "$token" -H "$user" -H "$tenant" -H "$content" {{meta_service_url}}/v3/meta/$DB/streams_channel_metadata
